...
public class TicketMasterClient {
	...
	private static final String API_KEY = "9KuAJvpSXOBThINj83IkwrCtrk9pIHxh";
	...
	private List<Item> getItemList(JSONArray events) throws JSONException {
		...
		Set<String> visitedItemNameList = new HashSet<>();
		for (int i = 0; i < events.length(); ++i) {
			JSONObject event = events.getJSONObject(i);
			if(visitedItemNameList.contains(event.getString("name"))) {
				continue;
			}
			visitedItemNameList.add(event.getString("name"));
